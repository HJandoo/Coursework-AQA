...
public class MapPanel extends JPanel{
	...
	public void paintComponent(Graphics g) {
		...
		Rectangle[] rects = new Rectangle[15];
		g.setColor(new Color(0, 129, 222));
		
		for (int i = 0; i < 15; i++) {
			rects[i] = new Rectangle(r.nextInt(1610) - 50, r.nextInt(970) - 50, r.nextInt(580) + 50, r.nextInt(230) + 30);
			
			while (rects[i].x < 60 || rects[i].x > 1860 || rects[i].y < 60 || rects[i].y > 1020) {
